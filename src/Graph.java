...
class Graph {
    ...
    // algorithm
    void KruskalMST(List<HyperChannel> hc, List<Planet> maxOfSolarSystems)
    {
        ...
        for (i = 0; i < e; ++i)
        {
            hc.add(new HyperChannel(maxOfSolarSystems.get(result[i].dest),maxOfSolarSystems.get(result[i].src),result[i].weight));
